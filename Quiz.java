...
public class Quiz extends JFrame implements ActionListener{
	...
	Quiz(String name )   {
		...
		quetion = new JLabel();
		quetion.setBounds(150, 450, 900, 30);
		quetion.setFont(new Font ("Tahoma",Font.PLAIN,24));
		add(quetion);
        ...
        next.setBounds(1100,540,200,40);
	...
	public void paint(Graphics g ) {
		...
		if (timer > 0 ) {
			...
			g.drawString("Times upp!!", 1100, 500);
	...
	public void start(int count) {
		...
		QNo.setText("" +( count + 1 )+ ". ");
		quetion.setText(questions[count][0]);
